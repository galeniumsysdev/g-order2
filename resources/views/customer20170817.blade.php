                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="personal">
                                  ...
                                  <div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
                                      ...
                                      <div class="col-sm-4">
                                        <select class="form-control" name="groupdc" id="groupdc" onchange="ubah(this.value)" required >
                                  ...
                                  <div class="form-group{{ $errors->has('distributor') ? ' has-error' : '' }}">
                                      ...
                                      <div class="col-sm-10" id='distributordiv'>
                                          <button type="button" class="search-modal btn btn-default">
                                            <span class="fa fa-search"></span> Add Distributor
                                          </button>
                                      </div>
                                  </div>
                                				...
                                				<div class="modal-body">
                                					<form class="form-horizontal" role="form">
                                						<div class="form-group">
                                							<label class="control-label col-sm-2" for="name">@lang('label.outlet'):</label>
                                							<div class="col-sm-10">
                                								<input type="name" class="form-control" id="distname">
                                							</div>
                                						</div>
                                            <div class="form-group">
                                							<label class="control-label col-sm-2" for="name">@lang('label.city'):</label>
                                							<div class="col-sm-10">
                                								<input type="name" class="form-control" id="distcity">
                                							</div>
                                						</div>
                                            <div class="form-group">
                                							<label class="control-label col-sm-2" for="name">@lang('label.state'):</label>
                                							<div class="col-sm-10">
                                								<input type="name" class="form-control" id="diststate">
                                							</div>
                                						</div>
                                            <div class="form-group">
                                							<div class="col-sm-10">
                                                <button type="button" class="btn actionBtn">
                                    							<span id="footer_action_button" class='fa fa-search'> </span>@lang('label.search')
                                    						</button>
                                							</div>
                                						</div>
                                					...
                                					<div class="modal-footer">
                                						<button type="button" class="btn actionBtn" data-dismiss="modal">
                                							<span id="footer_action_button" class='fa fa-plus'> </span>
                                              Add
                                						</button>
