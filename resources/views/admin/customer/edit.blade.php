                            ...
                            <div class="tab-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @else
                                        <input type="checkbox"  name="pharma_flag" id="pharma_flag" value="1"> Non PSC/Pharma<br>
                                        @endif
                              ...
                              @endif
                                    ...
                                    <div class="form-group" id="status">
                                        ...
                                        @endif
                                        <button type="submit" id="save-customer" class="btn btn-primary" value="save" name="save" title="@lang('label.save')"><i class="fa fa-floppy-o fa-2x" aria-hidden="true"></i></button>&nbsp;&nbsp;
                  										</div>
                                    </div>
                          ...
                          <th width="10%"><strong>@lang('label.action')</strong></th>
                            ...
                            <td data-title="@lang('label.action')">
                              <a class="btn btn-info btn-sm" href="#"><span class="glyphicon glyphicon-pencil"></span></a>
            						        {!! Form::open(['method' => 'DELETE','route' => ['profile.removeaddress', $customer_site->id],'style'=>'display:inline']) !!}
