...
class Customer extends Model
{
  ...
  protected $fillable = [
      ...
      ,'outlet_type_id','subgroup_dc_id','longitude','langitude','id_approval_psc','id_approval_pharma','date_approval_psc','date_approval_pharma','keterangan','export_flag','tollin_flag','parent_dist','payment_term_name'
  ];
